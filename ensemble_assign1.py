# -*- coding: utf-8 -*-
"""
Created on Thu Feb 25 02:54:27 2021
...
import pandas as pd
import numpy as np
cancer_data=pd.read_csv(r"C:\Users\Amarnadh Tadi\Desktop\datascience\assign9\Tumor_Ensemble.csv")
cancer_data.columns
cancer_data.dtypes
...
predictors=cancer_data.drop(['diagnosis'], axis='columns')
predictors.head()
target=cancer_data.iloc[:,[0]]
